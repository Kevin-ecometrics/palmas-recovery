        ...
        >
          {images.map((img, i) => (
            <button
              ...
              aria-label={t(`panorama.labels.${img.key}`, { lng })}
            >
              <img
                src={img.src}
                alt={t(`panorama.labels.${img.key}`, { lng })}
