...
export default function PrivateRoomPage() {
  ...
  const highlights = t("tour.private.highlights", {
    returnObjects: true,
  }) as Array<{
    title: string;
    desc: string;
  }>;
  const features = t("tour.private.features", {
    returnObjects: true,
  }) as string[];
        ...
        <div className="max-w-6xl mx-auto px-6 py-24 md:py-28 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              ...
              <Link
                href={getLocalizedPath("/tour/360/private", currentLang)}
