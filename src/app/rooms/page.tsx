        ...
        <div className="relative z-20 h-full flex items-center justify-center text-center px-4">
          <div className="max-w-5xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="group relative px-10 py-5 bg-white text-black font-bold text-lg overflow-hidden transition-all hover:scale-105">
                  ...
                  >
                    ...
                    <div className="lg:w-2/5 p-10 lg:p-16 flex flex-col justify-center bg-gradient-to-br from-gray-50 to-white rounded-3xl">
                      ...
                      <Link
                        ...
                        className="group/btn relative w-full bg-black text-white font-bold py-5 overflow-hidden transition-all hover:shadow-2xl rounded-full text-center mb-4"
                      >
